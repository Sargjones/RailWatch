...
CHANNELS = [
    ...
    # ── NATIONAL EXPANSION — PRAIRIE / BC ─────────────────────────────────────
    # Added 2026-06-16. Province filter OFF — cross-Canada content expected.
    # Backfill order: after Ontario channels complete (~Jul 11)

    {
        "id":               "UC9YbK-DpLdF7RlAPXHXa1KA",  # Winnipeg Railman (verified 2026-06-16)
        "name":             "Winnipeg Railman",
        "handle":           "@WinnipegRailman",
        "focus":            ["CN Winnipeg", "CPKC Carberry Sub", "CPKC Mainline", "VIA Rail", "BNSF Manitoba"],
        "default_location": "Winnipeg",
        "default_subdivision": "CN Mainline Manitoba",
        "default_lat":      49.8951,
        "default_lon":      -97.1384,
    ...
    {
        "id":               "UC0EU2sjkJ424t4zM0WYiFfA",  # The Cando Railfan (verified 2026-06-16)
        "name":             "The Cando Railfan",
        "handle":           "@CandoRailfan",
        "focus":            ["CN Winnipeg", "CPKC Manitoba", "branchlines", "GMD1", "industrial spurs"],
        "default_location": "Winnipeg",
        "default_subdivision": "CN Mainline Manitoba",
        "default_lat":      49.8951,
        "default_lon":      -97.1384,
    ...
    {
        "id":               "UCgCljqfPHJHRpf6LzItpV6Q",  # The Manitoba Railfan (verified 2026-06-16)
        "name":             "The Manitoba Railfan",
        "handle":           "@TheManitobaRailfan",
        "focus":            ["CN Manitoba", "CPKC Manitoba", "VIA Rail"],
        "default_location": "Winnipeg",
        "default_subdivision": "CN Mainline Manitoba",
        "default_lat":      49.8951,
        "default_lon":      -97.1384,
    ...
    {
        "id":               "UCVFk5I9nWbKJp-TVbKwgajQ",  # Central Canada Railfan (verified 2026-06-16)
        "name":             "Central Canada Railfan",
        "handle":           "@CentralCanadaRailfan",
        "focus":            ["CN Winnipeg", "CPKC Manitoba", "active 2026"],
        "default_location": "Winnipeg",
        "default_subdivision": "CN Mainline Manitoba",
        "default_lat":      49.8951,
        "default_lon":      -97.1384,
...
SUBDIVISION_PATTERNS = [
    ...
    # ── Prairie / BC subdivisions (added 2026-06-16) ─────────────────────────
    (r'\b(carberry\s+sub(?:division)?)\b',        {"subdivision": "CPKC Carberry Sub",      "name": "CPKC Carberry Sub",       "lat": 49.8700, "lon": -99.3500}),
    (r'\b(rivers\s+sub(?:division)?)\b',          {"subdivision": "CN Rivers Sub",          "name": "CN Rivers Sub",           "lat": 50.0300, "lon": -100.2400}),
    (r'\b(wainwright\s+sub(?:division)?)\b',      {"subdivision": "CN Wainwright Sub",      "name": "CN Wainwright Sub",       "lat": 52.8400, "lon": -110.8600}),
    (r'\b(edson\s+sub(?:division)?)\b',           {"subdivision": "CN Edson Sub",           "name": "CN Edson Sub",            "lat": 53.5800, "lon": -116.4300}),
    (r'\b(shuswap\s+sub(?:division)?)\b',         {"subdivision": "CPKC Shuswap Sub",       "name": "CPKC Shuswap Sub",        "lat": 50.9000, "lon": -119.2000}),
    (r'\b(mountain\s+sub(?:division)?)\b',        {"subdivision": "CPKC Mountain Sub",      "name": "CPKC Mountain Sub",       "lat": 51.1700, "lon": -117.9400}),
    (r'\b(laggan\s+sub(?:division)?)\b',          {"subdivision": "CPKC Laggan Sub",        "name": "CPKC Laggan Sub",         "lat": 51.4000, "lon": -116.2000}),
    (r'\b(brooks\s+sub(?:division)?)\b',          {"subdivision": "CPKC Brooks Sub",        "name": "CPKC Brooks Sub",         "lat": 51.0000, "lon": -112.0000}),
    (r'\b(red\s+deer\s+sub(?:division)?)\b',     {"subdivision": "CPKC Red Deer Sub",      "name": "CPKC Red Deer Sub",       "lat": 52.2681, "lon": -113.8112}),
]
...
OUT_OF_SCOPE_KEYWORDS = [
    # Out-of-province geography — US states and foreign content only
    # NOTE: Canadian prairie and BC content now welcome — see national channels
    "nova scotia", "new brunswick",
    "new york", "ohio", "michigan", "illinois", "indiana",
